...
namespace ToursManagement.Models
{
	public class TourSource
	{
		...
		static TourSource()
		{
			_tourStops = new List<TourStop>
			{
				...
				new TourStop
				{
					...
					ImageUri = "/Images/ArtInstitute.jpg",
					Selected = false,
		...
		{
			var result = _tourStops.ToList();
			return result;
		}

		public static List<TourStop> GetTourStops(int count)
		{
			var result = _tourStops.Take(count).ToList();
			return result;
		}
